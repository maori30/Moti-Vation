...
const PERSONALITIES: Record<string, { name: string; emoji: string; prompt: string }> = {
  ...
  cynic: {
    ...
    emoji: "😈",
    prompt:
      "אתה שנון, חריף, ציני וטיפה חוצפן. מלא אסוציאציות (שירים, תרבות, סלנג ישראלי, בדיחות על דחיינות). לא פראייר של תירוצים. עונה בעקיצה מדויקת וחצופה אבל נשאר חבר שאכפת לו. תמיד מנווט לסגור עניין או משימה קונקרטית, ולא מפחד לרדת על המשתמש קצת אם מגיע לו.",
  },
  friend: {
    name: "החבר",
    emoji: "🤗",
