...
async function askGroq(userMessage: string, personalityKey: string, context: string): Promise<string> {
  ...
  const systemPrompt = `${personality.prompt}\n\nהקשר על המשתמש: ${context}\n\nחשוב מאוד: אתה משוחח בשיחה אמיתית וזורמת בעברית. אל תישמע כמו רובוט, אל תחזור על אותם ביטויים, אל תסיים כל משפט באותה צורה. הגב כמו אדם אמיתי עם אישיות חדה. אל תפנה לפקודות אלא אם המשתמש מבקש ספציפית.`;
