      ...
      <article className="mx-auto max-w-3xl min-w-0 space-y-6 leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p className="text-gray-200">
            ...
            אישיויות שאתה בוחר ביניהן: הרס"ר שדוחף בלי רחמים, הציני עם הסרקזם,
            המאמן, החבר, המטפל, המעודד, הסבתא, הפילוסוף, הפראייר והשכן מלמעלה. אותה מטרה, טון אחר –
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pr-5 space-y-2 text-gray-200">
            ...
            <li><strong>😏 הפראייר</strong> – עושה לך חשק לזוז רק כדי לא להיות כמוהו.</li>
            <li><strong>🏠 השכן מלמעלה</strong> – מציק בדיוק כמו שאתה מכיר, עד שתסגור.</li>
          </ul>
          <p className="text-gray-200">
